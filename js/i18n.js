...
const DICT = {
  ...
  'log.calNote':         { ja: 'マスを押すと、カレンダーに出すスケッチを選べます。',
                           en: 'Tap a day to choose which sketch appears on the calendar.' },
  'log.pickCoverTitle':  { ja: 'カレンダーに出すスケッチ', en: 'Calendar sketch' },
  'log.pickCoverLead':   { ja: 'カレンダーに出すスケッチを選んでね。もう一度押すと大きく見られます。',
                           en: 'Pick the sketch for this day. Tap again to view it larger.' },
  'log.coverSet':        { ja: 'カレンダーに出しました', en: 'Set on calendar' },
  'log.coverBadge':      { ja: '表示中',               en: 'On calendar' },
  'log.notes':           { ja: 'タイムライン',           en: 'Timeline' },
  'log.notesDesc':       { ja: '自分のスケッチが新しい順に並びます。絵を押すとスケッチページが開きます。',
                           en: 'Your posts, newest first. Tap a drawing to open its page.' },
  'log.noNotes':         { ja: 'まだスケッチがありません。練習するとここに並びます。',
                           en: 'Nothing here yet. Sessions will show up after you practice.' },
  'log.loginNotes':      { ja: 'ログインすると自分のスケッチタイムラインが見られます',
                           en: 'Log in to see your post timeline' },
