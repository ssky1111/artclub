...
const DICT = {
  ...
  'rev.howWas':          { ja: '絵を見直して、気になるところをメモしよう',
                           en: 'Look back at your drawings and note what stands out.' },
  'rev.reflectNote':     { ja: '終わった後に振り返りの言葉を入れてみよう。練習効率がアップします。',
                           en: 'Try jotting a reflection after each session — it makes practice more efficient.' },
