...
const DICT = {
  ...
  'copy.note':            { ja: '「模写OK」の公開スケッチから選びます（自分の絵も可）。時間制限はありません。',
                            en: 'Pick a public copyable sketch (including yours). No time limit.' },
  'copy.pickHint':        { ja: 'スケッチを選んで「はじめる」を押してください', en: 'Select a sketch, then tap Start' },
  'copy.empty':           { ja: '模写OKの公開スケッチがまだありません。ふりかえりで「模写OK」をオンにして投稿してみてください。',
                            en: 'No copyable public sketches yet. Turn on “OK to copy” in review and post.' },
  'copy.loadFail':        { ja: 'スケッチを読み込めませんでした', en: 'Could not load artworks' },
  'copy.selected':        { ja: '{n} さんのスケッチを選択中', en: 'Selected {n}’s drawing' },
  'copy.selectedMine':    { ja: '自分のスケッチを選択中',     en: 'Your sketch selected' },
  ...
  'home.paywallTitle':   { ja: 'つづける',               en: 'Continue' },
