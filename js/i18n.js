...
const DICT = {
  ...
  'log.calNote':         { ja: '日付を押すと表紙を選べます。選ばない日はクロッキーのスケッチが使われます。',
                           en: 'Tap a date to pick its cover. Otherwise a croquis sketch is used.' },
  'log.setCover':        { ja: '表紙にする',           en: 'Set as cover' },
  'log.coverActive':     { ja: '表紙',                 en: 'Cover' },
  'log.coverAuto':       { ja: '自動に戻す',           en: 'Use automatic' },
  'log.coverPick':       { ja: 'カレンダーの表紙',     en: 'Calendar cover' },
