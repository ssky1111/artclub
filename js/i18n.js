...
const DICT = {
  ...
  'legal.privacy':        { ja: 'プライバシーポリシー',   en: 'Privacy Policy' },
  'legal.terms':          { ja: '利用規約',               en: 'Terms of Use' },
  ...
  'auth.changeHandle':     { ja: 'ユーザーIDを変更',      en: 'Change user ID' },
  'auth.setHandle':        { ja: 'ユーザーIDを決めてください', en: 'Choose a user ID' },
  'auth.handleNote':       { ja: '半角英字で始め、英数字と _ のみ（3〜20文字）。あとから変えられます。',
                             en: 'Start with a letter; letters, numbers, and _ only (3–20). You can change it later.' },
  'auth.handlePh':         { ja: 'userid',               en: 'userid' },
  'auth.handleOk':         { ja: '決定',                 en: 'OK' },
  'auth.handleTaken':      { ja: 'そのユーザーIDは使われています', en: 'That user ID is taken' },
  'auth.handleInvalid':    { ja: '半角英字で始め、英数字と _ のみ（3〜20文字）',
                             en: 'Start with a letter; use letters, numbers, and _ (3–20)' },
  'auth.handleLabel':      { ja: 'ユーザーID',            en: 'User ID' },
  ...
  'gal.loginToShare':     { ja: 'ログインしてスケッチを保存',  en: 'Log in to save your work' },
  'gal.delete':           { ja: 'このスケッチを消す',         en: 'Delete this artwork' },
  'gal.deleteConfirm':    { ja: 'このスケッチを消しますか？', en: 'Delete this artwork?' },
  ...
  'gal.allowCopy':        { ja: '模写OK',                 en: 'OK to copy' },
  'gal.allowCopyHint':    { ja: '模写モードで他の人があなたの絵を模写できるようになります', en: 'Lets others copy your drawings in copy mode' },
  ...
  'gal.savePhoto':        { ja: '写真に保存',               en: 'Save to Photos' },
  'gal.savedPhotoHint':   { ja: '共有シートから「画像を保存」を選ぶと写真に入ります',
                            en: 'Choose “Save Image” in the share sheet to add it to Photos' },
  'gal.downloaded':       { ja: 'ダウンロードしました',       en: 'Downloaded' },
  'gal.downloadFail':     { ja: 'ダウンロードに失敗しました', en: 'Download failed' },
  ...
  'atelier.emptyPublic':  { ja: 'まだ公開スケッチがありません', en: 'No public posts yet' },
  ...
  'atelier.copyStart':    { ja: '模写する',               en: 'Copy' },
  ...
  'atelier.modeMemoryCroquis': { ja: '暗記クロッキー',   en: 'Memory croquis' },
  ...
  'copy.selected':        { ja: '{n} さんのスケッチを選択中', en: 'Selected {n}’s drawing' },
  'copy.unavailable':     { ja: 'このスケッチはいま模写できません', en: 'This artwork can’t be copied right now' },
  ...
  'home.paywallTitle':   { ja: '無料開放中',             en: 'Free for now' },
  'home.paywallBody':    { ja: '本来は有料のメニューです。いまは無料で開放しています。',
                           en: 'This is normally a paid menu. It’s free for now.' },
  ...
  'sess.saveNext':       { ja: '保存して次へ',           en: 'Save & next' },
  'sess.saveFinish':     { ja: '保存して終わる',         en: 'Save & finish' },
  ...
  'sess.quitEmpty':     { ja: '終了しますか？（まだ1枚も保存していません）', en: 'Quit? (no drawings saved yet)' },
  ...
  'sess.memoryLook':     { ja: '1分間観察して覚えましょう', en: 'Observe for 1 minute and memorise' },
  ...
  'sess.memoryStartDraw': { ja: '描きはじめる', en: 'Start drawing' },
  ...
  'rev.howWas':          { ja: '終わった後に絵を見返して気付いたことをメモしてみましょう。練習効率がアップします',
                           en: 'After each session, look back at your drawings and jot down what you noticed — it makes practice more efficient.' },
  ...
  'rev.downloadAll':     { ja: '自分の絵を全てダウンロード', en: 'Download all my drawings' },
  ...
  'admin.login':         { ja: '管理者ログイン',       en: 'Admin sign-in' },
  'admin.loginNote':     { ja: '管理者用の Google アカウントでログインしてください。',
                           en: 'Sign in with the admin Google account.' },
  'admin.denied':        { ja: 'このアカウントには管理権限がありません。管理者用の Google アカウントでログインし直してください。',
                           en: 'This account is not an admin. Sign in with the admin Google account.' },
  'admin.unlock':        { ja: 'ひらく',               en: 'Open' },
  ...
  'analytics.title':     { ja: '利用解析',             en: 'Usage analytics' },
  'analytics.open':      { ja: 'ひらく',               en: 'Open' },
  'analytics.teaser':    { ja: '日ごとのモード別利用を確認できます。',
                           en: 'See daily usage by mode.' },
  ...
  'analytics.needAdminLogin': { ja: '管理者用の Google アカウントでログインしてください。',
                           en: 'Sign in with the admin Google account.' },
  ...
  'analytics.byMode':    { ja: 'モード別',             en: 'By mode' },
  'analytics.byUser':    { ja: 'ユーザー × モード',   en: 'Users × modes' },
  'analytics.user':      { ja: 'ユーザー',             en: 'User' },
  'analytics.mode':      { ja: 'モード',               en: 'Mode' },
  'analytics.rounds':    { ja: '回数',                 en: 'Rounds' },
  'analytics.total':     { ja: '合計',                 en: 'Total' },
  'analytics.last':      { ja: '最終',                 en: 'Last' },
  'analytics.trend':     { ja: '直近14日',             en: 'Last 14 days' },
  'analytics.date':      { ja: '日付',                 en: 'Date' },
  'analytics.modeBreakdown': { ja: '内訳',             en: 'Breakdown' },
  'analytics.chartTotal': { ja: '合計の推移',          en: 'Total trend' },
  'analytics.chartModes': { ja: 'モード別の推移',      en: 'Trend by mode' },
  'analytics.chartRounds': { ja: '回数',               en: 'Rounds' },
  'analytics.chartUsers': { ja: '人数',                en: 'Users' },
  'analytics.modeDaily': { ja: 'Daily',                en: 'Daily' },
  ...
  'analytics.modeMemoryCroquis': { ja: '暗記クロッキー', en: 'Memory croquis' },
  ...
  'log.calNote':         { ja: 'クロッキーのスケッチが、その日のマスに貼られます。日付を押すと一覧を見られます。',
                           en: 'A croquis sketch appears on each day. Tap a date to see all sketches.' },
  ...
  'log.loginNotes':      { ja: 'ログインすると、クラウドに保存したスケッチもきろくに表示されます',
                           en: 'Log in to include sketches saved to the cloud in your records' },
  ...
  'set.skinDefault':     { ja: 'シンプル（デフォルト）', en: 'Simple (default)' },
  'set.skinPastelRpg':   { ja: 'パステルRPG',           en: 'Pastel RPG' },
  ...
  'set.refCornerNote':   { ja: 'まとめ画像・ダウンロード時、各絵の左上にお題を小さく重ねます（描いているあいだは変わりません）',
                           en: 'On the summary sheet and downloads, overlay a small reference on each drawing’s top-left (does not change drawing mode)' },
